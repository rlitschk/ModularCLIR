...
# https://github.com/cambridgeltl/composable-sft/blob/main/examples/language-modeling/run_mlm.py
...
# from sft import SFT, LotteryTicketSparseFineTuner, SftArguments
...
class GPUArguments:
  ...
  device: Optional[str] = field(
    default=None, metadata={"help": "CUDA_VISIBLE_DEVICES environment variable."}
  )
...
def main():
  ...
  if data_args.dataset_name is not None:
    if "ru" in data_args.dataset_config_name or \
